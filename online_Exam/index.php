  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/pk.jpg" width=100 height=100 alt="Pooja Kumari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Pooja Kumari</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917050722294</h4>
		<h4 style="font-family:'typo' ">poojakumari2471@gmail.com</h4>
		<h4 style="font-family:'typo' ">International Institute For Spacial Education,Lucknow</h4></div></div>
		</p>
      </div>
